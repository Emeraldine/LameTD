class Tower
{
	constructer(atkdmg, atkspd, atkrange, tier, source)
  {
  	this.atkdmg = atkdmg;
    this.atkspd = atkspd;
  ...
  draw(ctx)
  {
    ...
    baseImg.src = this.src;
    ctx.drawImage(baseImg, this.posx, this.posy);
  }
}
class Enemy
{
...
bgImage.src = "https://github.com/Zekromeon/LameTD/blob/main/logan/Map2.png?raw=true";
...
canvas.addEventListener('mousedown', e => {
  ...
  case 1:
    ...
    allElems.push(new Tower(1, 1, 1, 1, elem.src));
  	break;
  default:
  	return;
  }
...
function selectTower(tier)
{
  ...
  case 1:
  	...
  	break;
  default:
  	console.log("incorret tower, stop being bad smh");
  	break;
  }
}
